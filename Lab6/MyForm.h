    ...
    private: System::Windows::Forms::Button^ button1;
           ...
           void InitializeComponent(void) {
               ...
               this->sortedBox->Items->AddRange(gcnew cli::array< System::Object^  >(4) {
                   L"b.Вставками;", L"c.Пузырьковая;",
                       L"d.Шейкера;", L"e.Быстрая."
               });
           ...
           System::Void aboutButton_Click(System::Object^ sender, System::EventArgs^ e) {
               MessageBox::Show("Калькулятор стека\nВерсия 1.0\nАвтор: Ваше имя", "О программе", MessageBoxButtons::OK, MessageBoxIcon::Information);
           }
